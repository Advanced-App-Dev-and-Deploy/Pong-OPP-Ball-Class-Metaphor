class Ball {
  //Variables
  private int ballX, ballY, ballMoveX, ballMoveY, directionX=0, directionY=0, targetX, targetY;
  ...
  public void drawStar() {
    ballDraw();
    starChase();
    println(targetX, targetY, mouseX, mouseY);
  }//End drawStar
  //
  ...
  //
  void starChase() {
    //45-degree movement algorith, i.e. slope=1/1
    if ( ballX < targetX ) {
      ballX++;
    } else {
      ballX--;
